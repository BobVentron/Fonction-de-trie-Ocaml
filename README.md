...
# Différentes fonctions de tris sur Ocaml avec l'analyse de leur efficacité.

  Voici quatre méthodes de tris de listes différentes. Ces algorithmes, à l’exception du premier, pourront trier des listes de n’importe quel type d’éléments, et dans n’importe quel ordre.
